...
function Dashboard() {
  ...
  return (
    <div className="animate-fade-in space-y-6">
      <section className="relative overflow-hidden rounded-2xl border border-red-600 bg-gradient-to-br from-white to-neutral-100 p-6 text-neutral-900 shadow-[0_12px_30px_rgba(0,0,0,0.08)] dark:bg-gradient-to-br dark:from-black dark:to-neutral-900 dark:text-zinc-100 dark:shadow-[0_12px_30px_rgba(0,0,0,0.35)]">
        ...
        <div className="relative z-10 flex flex-col gap-4 md:flex-row md:items-center md:justify-between">
          <div className="space-y-2">
            ...
            <div className="flex flex-wrap gap-2 pt-2">
              <span className="rounded-lg border border-red-600 bg-white px-3 py-1 text-[14px] text-neutral-700 dark:bg-zinc-900 dark:text-zinc-100">
                {eventsThisMonth} this month
              </span>
              <span className="rounded-lg border border-red-600 bg-white px-3 py-1 text-[14px] text-neutral-700 dark:bg-zinc-900 dark:text-zinc-100">
                {categoriesUsed} active categories
              </span>
              <span className="rounded-lg border border-red-600 bg-red-600/10 px-3 py-1 text-[14px] text-neutral-700 dark:text-zinc-100">
